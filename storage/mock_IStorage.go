...
// EntityPath provides a mock function with given fields: entitiesPath, entityRelativePath
func (_m *MockStorage) EntityPath(entitiesPath string, entityRelativePath string) string {
	ret := _m.Called(entitiesPath, entityRelativePath)
	...
	if rf, ok := ret.Get(0).(func(string, string) string); ok {
		r0 = rf(entitiesPath, entityRelativePath)
	} else {
		r0 = ret.Get(0).(string)
	}
...
func (_e *MockStorage_Expecter) EntityPath(entitiesPath interface{}, entityRelativePath interface{}) *MockStorage_EntityPath_Call {
	return &MockStorage_EntityPath_Call{Call: _e.mock.On("EntityPath", entitiesPath, entityRelativePath)}
}

func (_c *MockStorage_EntityPath_Call) Run(run func(entitiesPath string, entityRelativePath string)) *MockStorage_EntityPath_Call {
...
func (_m *MockStorage) Paths() (*AbsPaths, error) {
	ret := _m.Called()
	...
	if rf, ok := ret.Get(0).(func() *AbsPaths); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
...
func (_e *MockStorage_Expecter) Paths() *MockStorage_Paths_Call {
	return &MockStorage_Paths_Call{Call: _e.mock.On("Paths")}
}

func (_c *MockStorage_Paths_Call) Run(run func()) *MockStorage_Paths_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockStorage_Paths_Call) RunAndReturn(run func() (*AbsPaths, error)) *MockStorage_Paths_Call {
	_c.Call.Return(run)
	return _c
}
...
// TmpPaths provides a mock function with no fields
func (_m *MockStorage) TmpPaths() (*AbsPaths, error) {
	ret := _m.Called()
...
func (_e *MockStorage_Expecter) TmpPaths() *MockStorage_TmpPaths_Call {
	return &MockStorage_TmpPaths_Call{Call: _e.mock.On("TmpPaths")}
}

func (_c *MockStorage_TmpPaths_Call) Run(run func()) *MockStorage_TmpPaths_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockStorage_TmpPaths_Call) RunAndReturn(run func() (*AbsPaths, error)) *MockStorage_TmpPaths_Call {
	_c.Call.Return(run)
	return _c
}
