...
// Entity provides a mock function with given fields: entityPath, collectionName, entityUri, heryContent
func (_m *MockEntityValidation) Entity(entityPath string, collectionName string, entityUri string, heryContent map[string]interface{}) error {
	ret := _m.Called(entityPath, collectionName, entityUri, heryContent)
	...
	if rf, ok := ret.Get(0).(func(string, string, string, map[string]interface{}) error); ok {
		r0 = rf(entityPath, collectionName, entityUri, heryContent)
	} else {
		r0 = ret.Error(0)
	}
...
func (_e *MockEntityValidation_Expecter) Entity(entityPath interface{}, collectionName interface{}, entityUri interface{}, heryContent interface{}) *MockEntityValidation_Entity_Call {
	return &MockEntityValidation_Entity_Call{Call: _e.mock.On("Entity", entityPath, collectionName, entityUri, heryContent)}
}

func (_c *MockEntityValidation_Entity_Call) Run(run func(entityPath string, collectionName string, entityUri string, heryContent map[string]interface{})) *MockEntityValidation_Entity_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(string), args[2].(string), args[3].(map[string]interface{}))
	})
	return _c
}
...
func (_c *MockEntityValidation_Entity_Call) RunAndReturn(run func(string, string, string, map[string]interface{}) error) *MockEntityValidation_Entity_Call {
	_c.Call.Return(run)
	return _c
}
