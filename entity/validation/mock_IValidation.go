...
func (_m *MockEntityValidation) Entity(collectionName string, schema *jsonschema.Schema, heryContent map[string]interface{}) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(string, *jsonschema.Schema, map[string]interface{}) error); ok {
...
func (_c *MockEntityValidation_Entity_Call) Run(run func(collectionName string, schema *jsonschema.Schema, heryContent map[string]interface{})) *MockEntityValidation_Entity_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(*jsonschema.Schema), args[2].(map[string]interface{}))
	})
	return _c
}
...
func (_c *MockEntityValidation_Entity_Call) RunAndReturn(run func(string, *jsonschema.Schema, map[string]interface{}) error) *MockEntityValidation_Entity_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockEntityValidation) RootEntity(rootSchema *jsonschema.Schema, selfSchema *jsonschema.Schema, heryContent map[string]interface{}) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*jsonschema.Schema, *jsonschema.Schema, map[string]interface{}) error); ok {
...
func (_c *MockEntityValidation_RootEntity_Call) Run(run func(rootSchema *jsonschema.Schema, selfSchema *jsonschema.Schema, heryContent map[string]interface{})) *MockEntityValidation_RootEntity_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*jsonschema.Schema), args[1].(*jsonschema.Schema), args[2].(map[string]interface{}))
	})
	return _c
}
...
func (_c *MockEntityValidation_RootEntity_Call) RunAndReturn(run func(*jsonschema.Schema, *jsonschema.Schema, map[string]interface{}) error) *MockEntityValidation_RootEntity_Call {
	_c.Call.Return(run)
	return _c
}
