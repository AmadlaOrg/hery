...
// MockEntityValidation is an autogenerated mock type for the Validator interface
...
// Entity provides a mock function with given fields: schema, heryContent
func (_m *MockEntityValidation) Entity(schema *jsonschema.Schema, heryContent map[string]any) error {
	ret := _m.Called(schema, heryContent)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*jsonschema.Schema, map[string]any) error); ok {
		r0 = rf(schema, heryContent)
	} else {
		r0 = ret.Error(0)
	}
...
func (_e *MockEntityValidation_Expecter) Entity(schema interface{}, heryContent interface{}) *MockEntityValidation_Entity_Call {
	return &MockEntityValidation_Entity_Call{Call: _e.mock.On("Entity", schema, heryContent)}
}

func (_c *MockEntityValidation_Entity_Call) Run(run func(schema *jsonschema.Schema, heryContent map[string]any)) *MockEntityValidation_Entity_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*jsonschema.Schema), args[1].(map[string]any))
	})
	return _c
}
...
func (_c *MockEntityValidation_Entity_Call) RunAndReturn(run func(*jsonschema.Schema, map[string]any) error) *MockEntityValidation_Entity_Call {
	_c.Call.Return(run)
	return _c
}
