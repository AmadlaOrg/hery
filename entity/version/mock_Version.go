...
// MockEntityVersion is an autogenerated mock type for the Version interface
...
// GeneratePseudoPattern provides a mock function with given fields: name, _a1
func (_m *MockEntityVersion) GeneratePseudoPattern(name string, _a1 string) string {
	ret := _m.Called(name, _a1)

	if len(ret) == 0 {
		panic("no return value specified for GeneratePseudoPattern")
	}
...
// MockEntityVersion_GeneratePseudoPattern_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GeneratePseudoPattern'
type MockEntityVersion_GeneratePseudoPattern_Call struct {
	*mock.Call
}

// GeneratePseudoPattern is a helper method to define mock.On call
//   - name string
//   - _a1 string
func (_e *MockEntityVersion_Expecter) GeneratePseudoPattern(name interface{}, _a1 interface{}) *MockEntityVersion_GeneratePseudoPattern_Call {
	return &MockEntityVersion_GeneratePseudoPattern_Call{Call: _e.mock.On("GeneratePseudoPattern", name, _a1)}
}

func (_c *MockEntityVersion_GeneratePseudoPattern_Call) Run(run func(name string, _a1 string)) *MockEntityVersion_GeneratePseudoPattern_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockEntityVersion_GeneratePseudoPattern_Call) Return(_a0 string) *MockEntityVersion_GeneratePseudoPattern_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockEntityVersion_GeneratePseudoPattern_Call) RunAndReturn(run func(string, string) string) *MockEntityVersion_GeneratePseudoPattern_Call {
	_c.Call.Return(run)
	return _c
}
