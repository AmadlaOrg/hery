...
// MockEntity is an autogenerated mock type for the Service interface
...
// ReadAll provides a mock function with given fields: path
func (_m *MockEntity) ReadAll(path string) ([]map[string]any, error) {
	ret := _m.Called(path)
...
// MockEntity_ReadAll_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ReadAll'
type MockEntity_ReadAll_Call struct {
	*mock.Call
}

// ReadAll is a helper method to define mock.On call
//   - path string
func (_e *MockEntity_Expecter) ReadAll(path interface{}) *MockEntity_ReadAll_Call {
	return &MockEntity_ReadAll_Call{Call: _e.mock.On("ReadAll", path)}
}

func (_c *MockEntity_ReadAll_Call) Run(run func(path string)) *MockEntity_ReadAll_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
...
func (_c *MockEntity_ReadAll_Call) Return(_a0 []map[string]any, _a1 error) *MockEntity_ReadAll_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockEntity_ReadAll_Call) RunAndReturn(run func(string) ([]map[string]any, error)) *MockEntity_ReadAll_Call {
	_c.Call.Return(run)
	return _c
}
