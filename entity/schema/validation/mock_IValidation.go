...
// Id provides a mock function with given fields: id, collectionName, entityMeta
func (_m *MockEntitySchemaValidation) Id(id string, collectionName string, entityMeta entity.Entity) error {
	ret := _m.Called(id, collectionName, entityMeta)
	...
	if rf, ok := ret.Get(0).(func(string, string, entity.Entity) error); ok {
		r0 = rf(id, collectionName, entityMeta)
	} else {
		r0 = ret.Error(0)
	}
...
func (_e *MockEntitySchemaValidation_Expecter) Id(id interface{}, collectionName interface{}, entityMeta interface{}) *MockEntitySchemaValidation_Id_Call {
	return &MockEntitySchemaValidation_Id_Call{Call: _e.mock.On("Id", id, collectionName, entityMeta)}
}

func (_c *MockEntitySchemaValidation_Id_Call) Run(run func(id string, collectionName string, entityMeta entity.Entity)) *MockEntitySchemaValidation_Id_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(string), args[2].(entity.Entity))
	})
	return _c
}
...
func (_c *MockEntitySchemaValidation_Id_Call) RunAndReturn(run func(string, string, entity.Entity) error) *MockEntitySchemaValidation_Id_Call {
	_c.Call.Return(run)
	return _c
}
