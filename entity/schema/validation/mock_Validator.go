...
// MockEntitySchemaValidation is an autogenerated mock type for the Validator interface
...
// Id provides a mock function with given fields: id, entityUri
func (_m *MockEntitySchemaValidation) Id(id string, entityUri string) error {
	ret := _m.Called(id, entityUri)
...
//   - id string
//   - entityUri string
func (_e *MockEntitySchemaValidation_Expecter) Id(id interface{}, entityUri interface{}) *MockEntitySchemaValidation_Id_Call {
	return &MockEntitySchemaValidation_Id_Call{Call: _e.mock.On("Id", id, entityUri)}
}

func (_c *MockEntitySchemaValidation_Id_Call) Run(run func(id string, entityUri string)) *MockEntitySchemaValidation_Id_Call {
...
func (_c *MockEntitySchemaValidation_Id_Call) RunAndReturn(run func(string, string) error) *MockEntitySchemaValidation_Id_Call {
	_c.Call.Return(run)
	return _c
}
