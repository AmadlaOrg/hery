...
// MockCache is an autogenerated mock type for the Cache interface
...
// SelectEntity provides a mock function with given fields: uri
func (_m *MockCache) SelectEntity(uri string) (*entity.Entity, error) {
	ret := _m.Called(uri)
...
//   - uri string
func (_e *MockCache_Expecter) SelectEntity(uri interface{}) *MockCache_SelectEntity_Call {
	return &MockCache_SelectEntity_Call{Call: _e.mock.On("SelectEntity", uri)}
}

func (_c *MockCache_SelectEntity_Call) Run(run func(uri string)) *MockCache_SelectEntity_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
...
func (_c *MockCache_SelectEntity_Call) RunAndReturn(run func(string) (*entity.Entity, error)) *MockCache_SelectEntity_Call {
	_c.Call.Return(run)
	return _c
}
