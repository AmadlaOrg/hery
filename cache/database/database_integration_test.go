...
func Test_Integration_Insert(t *testing.T) {
	...
	entitiesTable := Table{
		...
		Rows: []Row{
			{
				"entity_type":       "github.com/AmadlaOrg/Application/WebServer@v1.0.0",
				"uri":               "github.com/AmadlaOrg/Application/WebServer@v1.0.0",
				"name":              "WebServer",
				"repo_url":          "https://github.com/AmadlaOrg/Application",
				"origin":            "github.com/AmadlaOrg/Application",
				"version":           "v1.0.0",
				"is_latest_version": true,
				"is_pseudo_version": false,
				"abs_path":          "/home/user/.cache/hery/entity/github.com/AmadlaOrg/Application/WebServer@v1.0.0",
				"have":              true,
				"hash":              "",
				"exist":             true,
				"schema_json":       "{}",
