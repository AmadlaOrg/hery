...
// MockSqlDb is an autogenerated mock type for the SqlDB interface
...
func (_m *MockSqlDb) Query(query string, args ...any) (*sql.Rows, error) {
	var _ca []interface{}
	_ca = append(_ca, query)
	_ca = append(_ca, args...)
	ret := _m.Called(_ca...)
...
// MockSqlDb_Query_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Query'
type MockSqlDb_Query_Call struct {
	*mock.Call
}
...
//   - query string
//   - args ...any
func (_e *MockSqlDb_Expecter) Query(query interface{}, args ...interface{}) *MockSqlDb_Query_Call {
	return &MockSqlDb_Query_Call{Call: _e.mock.On("Query",
		append([]interface{}{query}, args...)...)}
}

func (_c *MockSqlDb_Query_Call) Run(run func(query string, args ...any)) *MockSqlDb_Query_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]any, len(args)-1)
		for i, a := range args[1:] {
			if a != nil {
...
func (_c *MockSqlDb_Query_Call) Return(_a0 *sql.Rows, _a1 error) *MockSqlDb_Query_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockSqlDb_Query_Call) RunAndReturn(run func(string, ...any) (*sql.Rows, error)) *MockSqlDb_Query_Call {
	_c.Call.Return(run)
	return _c
}
