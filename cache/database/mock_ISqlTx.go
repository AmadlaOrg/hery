...
func (_m *MockSqlTx) Exec(query string, args ...interface{}) (sql.Result, error) {
	var _ca []interface{}
...
func (_c *MockSqlTx_Exec_Call) Run(run func(query string, args ...interface{})) *MockSqlTx_Exec_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockSqlTx_Exec_Call) RunAndReturn(run func(string, ...interface{}) (sql.Result, error)) *MockSqlTx_Exec_Call {
	_c.Call.Return(run)
	return _c
}
