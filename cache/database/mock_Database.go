...
// MockCacheDatabase is an autogenerated mock type for the Database interface
...
// QueryRows provides a mock function with given fields: query, args
func (_m *MockCacheDatabase) QueryRows(query string, args ...any) ([]map[string]any, error) {
	var _ca []interface{}
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(string, ...any) ([]map[string]any, error)); ok {
		return rf(query, args...)
	}
	if rf, ok := ret.Get(0).(func(string, ...any) []map[string]any); ok {
		r0 = rf(query, args...)
	} else {
		if ret.Get(0) != nil {
...
// MockCacheDatabase_QueryRows_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'QueryRows'
type MockCacheDatabase_QueryRows_Call struct {
	*mock.Call
}
...
//   - query string
//   - args ...any
func (_e *MockCacheDatabase_Expecter) QueryRows(query interface{}, args ...interface{}) *MockCacheDatabase_QueryRows_Call {
	return &MockCacheDatabase_QueryRows_Call{Call: _e.mock.On("QueryRows",
		append([]interface{}{query}, args...)...)}
}

func (_c *MockCacheDatabase_QueryRows_Call) Run(run func(query string, args ...any)) *MockCacheDatabase_QueryRows_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockCacheDatabase_QueryRows_Call) Return(_a0 []map[string]any, _a1 error) *MockCacheDatabase_QueryRows_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockCacheDatabase_QueryRows_Call) RunAndReturn(run func(string, ...any) ([]map[string]any, error)) *MockCacheDatabase_QueryRows_Call {
	_c.Call.Return(run)
	return _c
}
