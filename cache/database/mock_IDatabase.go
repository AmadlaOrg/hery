...
func (_m *MockCacheDatabase) CreateTable(table Table) {
	_m.Called(table)
}
...
func (_c *MockCacheDatabase_CreateTable_Call) RunAndReturn(run func(Table)) *MockCacheDatabase_CreateTable_Call {
	_c.Run(run)
	return _c
}
...
func (_m *MockCacheDatabase) DropTable(table Table) {
	_m.Called(table)
}
...
func (_c *MockCacheDatabase_DropTable_Call) Return() *MockCacheDatabase_DropTable_Call {
	_c.Call.Return()
	return _c
}

func (_c *MockCacheDatabase_DropTable_Call) RunAndReturn(run func(Table)) *MockCacheDatabase_DropTable_Call {
	_c.Run(run)
	return _c
}
