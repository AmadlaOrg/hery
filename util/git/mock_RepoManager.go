...
func (_m *MockGit) CheckoutTag(repoPath string, tagName string) error {
...
// MockGit_CheckoutTag_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CheckoutTag'
type MockGit_CheckoutTag_Call struct {
	*mock.Call
}
...
//   - repoPath string
//   - tagName string
func (_e *MockGit_Expecter) CheckoutTag(repoPath interface{}, tagName interface{}) *MockGit_CheckoutTag_Call {
	return &MockGit_CheckoutTag_Call{Call: _e.mock.On("CheckoutTag", repoPath, tagName)}
}

func (_c *MockGit_CheckoutTag_Call) Run(run func(repoPath string, tagName string)) *MockGit_CheckoutTag_Call {
...
func (_c *MockGit_CheckoutTag_Call) Return(_a0 error) *MockGit_CheckoutTag_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockGit_CheckoutTag_Call) RunAndReturn(run func(string, string) error) *MockGit_CheckoutTag_Call {
	_c.Call.Return(run)
	return _c
}
